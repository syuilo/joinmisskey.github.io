module.exports = (htm, urlprefix) => {
  ...
  $('h2').addClass('mt-5 p-2 border-top border-bottom border-primary border-3')
  $('h3').addClass('mt-4 p-1 border-bottom border-primary border-2')
  $('h4').addClass('mt-4 p-1 border-bottom border-primary')
  $('h5, h6').addClass('mt-3 p-1 border-bottom border-gray')
  $('div h2').removeClass('mt-5 p-2 border-top border-bottom border-primary border-3')
  $('div h3').removeClass('mt-4 p-1 border-bottom border-primary border-2')
  $('div h4').removeClass('mt-4 p-1 border-bottom border-primary')
  $('div h5, div h6').removeClass('mt-3 p-1 border-bottom border-light')
